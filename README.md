...
- [A Student's cookbook](#a-student-s-cookbook)
- [About](#about)
    + [User Stories](#user-stories)
    + [Reasons for the website](#reasons-for-the-website)
- [Scope](#scope)
    + [What the user may expect](#what-the-user-may-expect)
    + [What the user may want](#what-the-user-may-want)
- [Structure](#structure)
  * [Wireframes](#wireframes)
      - [Website navigation (front-end)](#website-navigation--front-end-)
      - [User who is not logged in](#user-who-is-not-logged-in)
      - [User who is logged in](#user-who-is-logged-in)
...
- [Features](#features)
  ...
  * [Testing](#testing)
      - [Bugs that occurred during development](#bugs-that-occurred-during-development)
    + [Automated Testing](#automated-testing)
      - [Code Validation](#code-validation)
      - [[W3Validator](https://validator.w3.org/)](#-w3validator--https---validatorw3org--)
      - [Home Page](#home-page)
      - [[CSS Validator](https://jigsaw.w3.org/css-validator/validator)](#-css-validator--https---jigsaww3org-css-validator-validator-)
      - [AmIResponsive](#amiresponsive)
      - [[Pep8](http://pep8online.com/checkresult#)](#-pep8--http---pep8onlinecom-checkresult--)
      - [Google Lighthouse](#google-lighthouse)
      - [JsHint](#jshint)
    + [Manual Testing](#manual-testing)
    + [Testing User Stories](#testing-user-stories)
    + [What the user may expect](#what-the-user-may-expect-1)
    + [What the user may want](#what-the-user-may-want-1)
